...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                ...
                '        <div class="file-caption-info" name="image_name">{caption}</div>\n' +
                ...
                if ($h.isEmpty(data) || $h.isEmpty(data.error)) {
                    ...
                    if (self.showPreview) {
                        $thumbs.each(function () {
                            ...
                            $thumb.find('.kv-file-remove').hide().removeAttr('disabled');
                        });
        ...
        _setThumbStatus: function ($thumb, status) {
            ...
            if (status === 'Error' && !self.retryErrorUploads) {
                ...
                // $thumb.find('.kv-file-remove').attr('disabled', true);
            }
        },
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgPlaceholder: 'or select {files}...',
